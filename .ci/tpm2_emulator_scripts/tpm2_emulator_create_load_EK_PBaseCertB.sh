...
echo "Creating PBaseCertB Platform Cert..."
...
rm -f $PC_DIR/PBaseCertB.der

#/opt/paccor/scripts/allcomponents.sh > $PC_DIR/PBaseCertB.componentlist.json
...
/opt/paccor/bin/signer -c $PC_DIR/PBaseCertB.componentlist.json -o $PC_DIR/observerFile -x $PC_DIR/extensionsFile -b 20180101 -a 20280101 -N $RANDOM -k $ca_key -P $ca_cert -e $ek_cert -f $PC_DIR/$platform_base_cert
